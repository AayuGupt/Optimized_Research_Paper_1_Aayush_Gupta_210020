...
density_map = np.load('C:\\aayush\\main\\IITK COURSE\\EE798\\researchpaper1\\final\\MPCount\\data\\sta\\train\\IMG_13_dmap.npy')

# Load the corresponding image (assuming it's in .jpg format)
image = Image.open('C:\\aayush\\main\\IITK COURSE\\EE798\\researchpaper1\\final\\MPCount\\data\\sta\\train\\IMG_13.jpg')
